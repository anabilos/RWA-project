            ...
            <div class="card">
                ...
                <div class="card-body">
                  @if (session()->has('success_message'))
                   ...
                   @endif
                    <h3>Dodaj Proizvod</h3></br>
                  <a class="btn-link"href="{{ url('/product/create') }}"><h6 style="padding=20px">Odjeća</h6></a>
                <a class="btn-link"href="{{ url('/product/createten') }}"><h6 style="padding=20px">Obuća</h6></a>
